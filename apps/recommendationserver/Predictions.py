...
db = psycopg2.connect(host='localhost', database='chrisrecommend', user='postgres', password='ekrizz24', port=5432)

# db = pymysql.connect(host='localhost', user='postgres', password='ekrizz24')

cursor = db.cursor()
API_key= 'e2dd9557cce6ec703895165056b8b28a'
